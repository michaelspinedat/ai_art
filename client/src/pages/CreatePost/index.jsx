...
const CreatePost = () => {
  ...
  const handleSurpriseMe = () => {
    ...
    setForm(curr => ({ ...curr, prompt: randomPrompt }))
  }
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
        ...
        <div className='mt-10'>
          <p className='mt-2 text-[#666E75] text-[14px]'>Once you have created the image you want, you cant share it with others in the community</p>
